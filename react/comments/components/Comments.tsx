...
import { AccordionDetails, AccordionSummary, Box, Button, Divider, Stack,
...
import { CardAccordion, PermissionCodes } from "@/fx/ui"
...
const Comments = () => {
  ...
  return (
    <CardAccordion>
      <AccordionSummary aria-controls="comments-content" id="comments-header" sx={{ p: 0, }} >
        <Box sx={{width: '100%'}}><Divider >Comments</Divider></Box>
      </AccordionSummary>
      <AccordionDetails>
